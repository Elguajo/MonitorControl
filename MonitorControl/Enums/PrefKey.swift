...
enum PrefKey: String {
  ...
  /* -- Brightness scheduler (Feature A) -- */

  /// Brightness scheduler enabled
  case scheduleEnabled

  /// Morning set-point time, stored as minutes from midnight (Int)
  case scheduleMorningTime

  /// Morning target brightness (Float 0...1)
  case scheduleMorningBrightness

  /// Evening set-point time, stored as minutes from midnight (Int)
  case scheduleEveningTime
  ...
  case useAlternateInputAddressing
